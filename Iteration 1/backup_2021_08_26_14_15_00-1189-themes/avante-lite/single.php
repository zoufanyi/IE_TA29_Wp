			...
			<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class( 'mb-5' ); ?>>
	                ...
	                <p class="meta text-info">
										...
										<?php printf( esc_html__( '%1$s on %2$s', 'avante-lite' ), '<a href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html( get_the_author() ) . '</a>', get_the_time( get_option( 'date_format' ) )	); ?>
