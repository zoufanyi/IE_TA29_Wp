...
//print_r($options);
	...
	private function repeater_control($value = '', $avadanta_limit='', $type_with_id=''){
		...
		if ( ( count( $social_repeater ) == 1 && '' === $social_repeater[0] ) || empty( $social_repeater ) ) { ?>
			...
			<button class="social-repeater-add-social-item button-secondary <?php echo esc_attr($avadanta_limit);?> <?php echo esc_attr($type_with_id);?>"><?php esc_html_e( 'Add Icon', 'avadanta' ); ?></button>
			<?php
		}
	}
}