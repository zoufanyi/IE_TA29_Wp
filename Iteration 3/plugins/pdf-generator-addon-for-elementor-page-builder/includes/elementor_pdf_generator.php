...
class RTWWPGE_Widget_PDF extends Widget_Base {
	...
	protected function render() {
		...
		<a style="cursor:pointer;" target="_blank" rel="noindex,nofollow" data-post_url="'.esc_url ( add_query_arg ( 'generate_pdf', 'true', get_permalink ( $post->ID ) ) ).'" data-post_id="' .$post->ID. '" data-pdf_cache="'.$rtw_is_cache.'" title="Download PDF" class="rtwwpge_pdf_button">
