...
class Avadanta_Customizer_Notify {
	...
	public function avadanta_customizer_notify_scripts_for_customizer() {
		...
		wp_enqueue_style( 'avadanta-customizer-notify-css', get_template_directory_uri() . '/library/customizer-plugin-notice/css/avadanta-customizer-notify.css', array());

		wp_enqueue_style( 'avadanta-plugin-install' );
		wp_enqueue_script( 'avadanta-plugin-install' );
		wp_add_inline_script( 'avadanta-plugin-install', 'var pagenow = "customizer";' );

		wp_enqueue_script( 'avadanta-updates' );

		wp_enqueue_script( 'avadanta-customizer-notify-js', get_template_directory_uri() . '/library/customizer-plugin-notice/js/avadanta-customizer-notify.js', array( 'customize-controls' ));
		wp_localize_script(
			'avadanta-customizer-notify-js', 'AvadantaCustomizercompanionObject', array(
				...
				'avadanta_activating_string'  => __( 'Activating', 'avadanta' ),
			)
		);
	...
	public function avadanta_plugin_notification_customize_register( $wp_customize ) {
		...
		require_once get_template_directory() . '/library/customizer-plugin-notice/avadanta-customizer-notify-section.php';
