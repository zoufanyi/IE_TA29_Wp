...
function TDI_import_files() {
	return array(
		array(
			'import_file_name'           => 'Avante Lite Demo Content',
			'import_file_url'            => 'https://www.themely.com/download/demo/avante-lite/content.xml',
			'import_widget_file_url'     => 'https://www.themely.com/download/demo/avante-lite/widgets.wie',
			'import_customizer_file_url' => 'https://www.themely.com/download/demo/avante-lite/settings.dat',
		),
	);
}
